...
| [dsh-remote](https://github.com/Blank-not-black/dsh-Remote) | 移动远程控制台：DSH 内访问 `/remote` 操控会话/后台工作/审批/提问/子代理/goal，零网关零令牌零额外端口（monorepo 子目录包） | `dsh plugin --profile web add "github:Blank-not-black/dsh-Remote#main&path:/packages/plugin"` |
